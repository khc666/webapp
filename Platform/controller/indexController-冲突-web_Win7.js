...
exports.main = async function (req, res, next) {
    var sql1 = 'SELECT id,name,city,price,number,img,picture FROM product WHERE tid = 2 limit 8';
    var data1 = await querydb(sql1);
    var sql2 = 'SELECT id,name,city,price,number,img,picture FROM product WHERE tid = 3 limit 4';
    var data2 = await querydb(sql2);
    var sql3 = 'SELECT id,name,city,price,number,img,picture FROM product WHERE tid = 3 limit 4 ,4';
    var data3 = await querydb(sql3);
    var json = {phoneLi:data1,houseLi:data2,houseLi2:data3};
...
exports.details = async function (req, res) {
    ...
    var sql = 'SELECT id,name,city,price,number,img FROM product WHERE id =?';
    var data = await querydb(sql,[id]);
    res.render('details',{commodity:data});
};